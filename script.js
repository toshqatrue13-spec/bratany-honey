...
// ===== BURGER =====
var burger=document.getElementById('burger'),mobileMenu=document.getElementById('mobileMenu'),navEl=document.querySelector('nav');
burger.addEventListener('click',function(){
  var opening=!mobileMenu.classList.contains('open');
  burger.classList.toggle('open');
  mobileMenu.classList.toggle('open');
  if(navEl) navEl.classList.toggle('menu-open', opening);
});
mobileMenu.addEventListener('click',function(e){if(e.target===mobileMenu)closeMenu()});
function closeMenu(){burger.classList.remove('open');mobileMenu.classList.remove('open');if(navEl)navEl.classList.remove('menu-open');}
